...
import second      # visualizer module
import summarizer  # summarizer module
...
def upload():
    ...
    try:
        ...
        # 3) Summarize
        summary = summarizer.summarize_csv(processed_path)

        # Pass both visuals and summary to result.html
        return render_template("result.html", visuals=visuals, summary=summary)
